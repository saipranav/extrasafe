...
function inject(){
	$("input[type=password]:not(.extrasafe-child)[extrasafe!=extrasafe-parent]").each(function(){
		...
		var extrasafeHelper = $('<img class="extrasafe-helper" title="Not your computer? Stay still for 5 sec to open our backup plan!" src="'+chrome.extension.getURL("icons/Info16.png")+'"></img>');
